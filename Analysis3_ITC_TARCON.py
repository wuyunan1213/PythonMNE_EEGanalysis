...
ave_itcDIFF.plot_topo(title='Inter-Trial coherence', vmin=0., vmax=0.1)
...
#ave_itcDIFF.plot(ave_itcDIFF.data, baseline=(-0.2, 0), mode='logratio', title='TargetControlItcDifference_%s' %(sesh))
ave_itcDIFF_PRE.plot_topo(title='Inter-Trial coherence_PRE', vmin=0., vmax=0.1)